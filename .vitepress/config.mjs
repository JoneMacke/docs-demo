...
export default defineConfig({
  ...
  locales: {
    ...
    en: {
      ...
      lang: 'en-US',
      title: 'Maple AI',
      description: 'Stable, Secure, and Clear Service Documentation',
      themeConfig: {
        nav: [
          { text: 'Home', link: '/en/' },
