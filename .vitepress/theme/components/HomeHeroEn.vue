<template>
  <div class="home-wrapper">
    <section class="vcontainer">
      ...
      <div class="describe">
        <p>Simple and Clear API Documentation with Video Tutorials</p>
      </div>
      <div class="vactions">
        <div class="vaction">
          <a href="/en/guide/" class="primary">
            Browse Docs
        ...
        <div class="vaction">
          <a href="https://check.taiko.qzz.io" class="status">
            Model Status
            <svg viewBox="0 0 24 24" width="1.2em" height="1.2em">
              <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 12h14m-7-7l7 7l-7 7"></path>
            </svg>
        ...
        <div class="vaction">
          <a href="/en/guide/community" class="accent">
            Community
            <svg viewBox="0 0 24 24" width="1.2em" height="1.2em">
              <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 12h14m-7-7l7 7l-7 7"></path>
            </svg>
        ...
        <div class="vaction">
          <a href="/en/guide/shop" class="warning">
            Store
            <svg viewBox="0 0 24 24" width="1.2em" height="1.2em">
              <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 12h14m-7-7l7 7l-7 7"></path>
            </svg>
